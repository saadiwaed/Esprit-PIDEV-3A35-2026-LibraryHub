 ...
 */
final class Version20260220164156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE community (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, purpose VARCHAR(255) NOT NULL, rules LONGTEXT DEFAULT NULL, icon VARCHAR(50) DEFAULT NULL, welcome_message LONGTEXT DEFAULT NULL, contact_email VARCHAR(180) DEFAULT NULL, is_public TINYINT(1) DEFAULT 1 NOT NULL, status VARCHAR(20) NOT NULL, member_count INT DEFAULT 0 NOT NULL, post_count INT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE journal_lecture (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, titre VARCHAR(255) NOT NULL, livre_id INT NOT NULL, date_lecture DATE NOT NULL, duree_minutes INT NOT NULL, lieu VARCHAR(255) DEFAULT NULL, concentration INT NOT NULL, page_lues INT NOT NULL, resume VARCHAR(255) NOT NULL, reflexion VARCHAR(255) DEFAULT NULL, note_perso INT NOT NULL, user_id INT NOT NULL, defi_id INT DEFAULT NULL, INDEX IDX_11DC37ADA76ED395 (user_id), INDEX IDX_11DC37AD73F00F27 (defi_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, status VARCHAR(20) NOT NULL, spoiler_warning TINYINT(1) DEFAULT 0 NOT NULL, is_pinned TINYINT(1) DEFAULT 0 NOT NULL, allow_comments TINYINT(1) DEFAULT 1 NOT NULL, external_url VARCHAR(500) DEFAULT NULL, comment_count INT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, community_id INT NOT NULL, INDEX IDX_5A8A6C8DFDA7B0BF (community_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE journal_lecture ADD CONSTRAINT FK_11DC37ADA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE journal_lecture DROP FOREIGN KEY FK_11DC37ADA76ED395');
